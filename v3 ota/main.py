...
oled.fill(0)
oled.fill(0)
write12.text("Starting...", 40, 60)
oled.show()
oled.fill(0)
write12.text("Starting...", 40, 55)
oled.show()
oled.fill(0)
write12.text("Starting...", 40, 50)
oled.show()

oled.fill(0)
write12.text("Starting...", 40, 45)
oled.show()
oled.fill(0)
write12.text("Starting...", 40, 40)
oled.show()
oled.fill(0)
write12.text("Starting...", 40, 35)
oled.show()
oled.fill(0)

oled.fill(0)
write12.text("Starting...", 40, 30)
oled.show()
oled.fill(0)
